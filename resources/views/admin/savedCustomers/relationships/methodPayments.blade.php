    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-methodPayments">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  $('.datatable-methodPayments:not(.ajaxTable)').DataTable({ buttons: dtButtons })

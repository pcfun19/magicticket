...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.businessDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-details.update", [$businessDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.businessDetail.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $businessDetail->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taxid') ? 'is-invalid' : '' }}" type="text" name="taxid" id="taxid" value="{{ old('taxid', $businessDetail->taxid) }}" required>
                @if($errors->has('taxid'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('activities_details') ? 'is-invalid' : '' }}" name="activities_details" id="activities_details" required>{{ old('activities_details', $businessDetail->activities_details) }}</textarea>

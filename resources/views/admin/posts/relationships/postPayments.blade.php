    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-postPayments">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  $('.datatable-postPayments:not(.ajaxTable)').DataTable({ buttons: dtButtons })

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tickets.update", [$ticket->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uuid') ? 'is-invalid' : '' }}" type="text" name="uuid" id="uuid" value="{{ old('uuid', $ticket->uuid) }}">
                @if($errors->has('uuid'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('event') ? 'is-invalid' : '' }}" name="event_id" id="event_id">
                    @foreach($events as $id => $event)
                        <option value="{{ $id }}" {{ ($ticket->event ? $ticket->event->id : old('event_id')) == $id ? 'selected' : '' }}>{{ $event }}</option>
                    @endforeach
                </select>
                @if($errors->has('event'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_available') ? 'is-invalid' : '' }}" type="number" name="total_available" id="total_available" value="{{ old('total_available', $ticket->total_available) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $ticket->price) }}" step="0.01" required min="5">
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('currency') ? 'is-invalid' : '' }}" name="currency" id="currency" required>
                    ...
                    @foreach(App\Ticket::CURRENCY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('currency', $ticket->currency) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('includes') ? 'is-invalid' : '' }}" name="includes" id="includes" required>{{ old('includes', $ticket->includes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('instructions') ? 'is-invalid' : '' }}" name="instructions" id="instructions">{{ old('instructions', $ticket->instructions) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('event_date') ? 'is-invalid' : '' }}" type="text" name="event_date" id="event_date" value="{{ old('event_date', $ticket->event_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('top_margin') ? 'is-invalid' : '' }}" type="number" name="top_margin" id="top_margin" value="{{ old('top_margin', $ticket->top_margin) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('left_margin') ? 'is-invalid' : '' }}" type="number" name="left_margin" id="left_margin" value="{{ old('left_margin', $ticket->left_margin) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('font_size') ? 'is-invalid' : '' }}" type="number" name="font_size" id="font_size" value="{{ old('font_size', $ticket->font_size) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('font_angle') ? 'is-invalid' : '' }}" type="number" name="font_angle" id="font_angle" value="{{ old('font_angle', $ticket->font_angle) }}" step="1" required>

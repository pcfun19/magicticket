    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-profilePosts">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.post.fields.uuid') }}
                            </th>
                            <th>
                                {{ trans('cruds.post.fields.assets') }}
                            </th>
                            <th>
                                {{ trans('cruds.post.fields.caption') }}
                            </th>
                            <th>
                                {{ trans('cruds.post.fields.privacy') }}
                            </th>
                            <th>
                                {{ trans('cruds.post.fields.price') }}
                            </th>
                            <th>
                                {{ trans('cruds.post.fields.profile') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($posts as $key => $post)
                            <tr data-entry-id="{{ $post->id }}">
                                ...
                                <td>
                                    @foreach($post->assets as $key => $media)
                                ...
                                <td>
                                    {{ App\Post::PRIVACY_SELECT[$post->privacy] ?? '' }}
                                </td>
                                <td>
                                    {{ $post->price ?? '' }}
                                </td>
...
@endcan
  ...
  $('.datatable-profilePosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })

    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-profilePayments">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.payment.fields.profile') }}
                            </th>
                            <th>
                                {{ trans('cruds.payment.fields.post') }}
                            </th>
                            <th>
                                {{ trans('cruds.payment.fields.message') }}
                            </th>
                            <th>
...
@endcan
  ...
  $('.datatable-profilePayments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
